...
RSpec.describe Flatirons::Saas::Subscription, type: :model do
  ...
  describe 'stripe integration' do
    ...
    context 'given a subscriptable and product and price' do
      it 'should create a subscription on database and stripe' do
        ...
        subscription = Flatirons::Saas::Subscription.create(subscriptable: subscriptable, product: product, stripe_price_id: stripe_price.id, status: :active)
    ...
    context 'given a subscription' do
      let!(:subscription) do
        Flatirons::Saas::Subscription.create(subscriptable: subscriptable, product: product, stripe_price_id: stripe_price.id, status: :active)
      end
